"""Handles HTML output for structured code summaries."""
...
def save_as_html(output_file: Path, data: dict, title="Project Code Summary"):
    """Saves extracted code summary as an HTML report."""
    try:

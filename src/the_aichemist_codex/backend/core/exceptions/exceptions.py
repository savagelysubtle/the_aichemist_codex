...
class ConfigError(AiChemistError):
    ...
    def __init__(
        self, message: str, config_key: str | None = None, details: str | None = None
    ) -> None:
        """
        Initialize the exception.
...
class FileError(AiChemistError):
    ...
    def __init__(
        self, message: str, file_path: str | None = None, details: str | None = None
    ) -> None:
        """
        Initialize the exception.
...
class CacheError(AiChemistError):
    ...
    def __init__(
        self, message: str, cache_key: str | None = None, details: str | None = None
    ) -> None:
        """
        Initialize the exception.
...
class OperationTimeoutError(AiChemistError):
...
class AuthenticationError(AiChemistError):
    ...
    def __init__(
        self, message: str, user: str | None = None, details: str | None = None
    ) -> None:
        """
        Initialize the exception.

...
class TagHierarchy:
    ...
    def is_related(self, tag1_id: int, tag2_id: int) -> bool:
        ...
        return len(ancestors1.intersection(ancestors2)) > 0
    ...
    def export_taxonomy(self, root_tag_id: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def import_taxonomy(
        self, taxonomy: Dict[str, Any], parent_id: Optional[int] = None
    ) -> Dict[str, int]:
        """

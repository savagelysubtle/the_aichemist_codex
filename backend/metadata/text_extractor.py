...
class TextMetadataExtractor(BaseMetadataExtractor):
    ...
    def __init__(
        ...
        Args:
            ...
            min_keyword_length: Minimum length of keywords to consider
            min_keyword_freq: Minimum frequency of keywords to consider
        """
    ...
    def _extract_keywords(self, content: str) -> List[str]:
        ...
        try:
            ...
            # Get feature scores
            feature_scores = zip(feature_names, np.asarray(X.sum(axis=0)).ravel())
    ...
    def _extract_entities(self, content: str) -> Dict[str, List[str]]:
        ...
        """
        entities = {"emails": [], "urls": [], "dates": [], "phone_numbers": []}

        # Extract emails
        emails = set(self.email_pattern.findall(content))
        entities["emails"] = list(emails)
        ...
        phone_numbers = set(self.phone_pattern.findall(content))
        entities["phone_numbers"] = list(phone_numbers)

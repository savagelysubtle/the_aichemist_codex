...
from the_aichemist_codex.backend.models.embeddings import TextEmbeddingModel
from the_aichemist_codex.backend.search.providers.regex_provider import (
    RegexSearchProvider,
)
...
class SearchEngine:
    ...
    async def add_to_index_async(self, file_metadata: FileMetadata):
        ...
        try:
            ...
            encoding_result = await asyncio.to_thread(
    ...
    async def find_file_groups_async(
        ...
        if file_paths is not None:
            ...
            converted_paths = [path for path in file_paths]

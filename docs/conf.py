...
CIRCULAR_MODULES = [
    ...
    # Clean architecture modules that might cause circular imports
    "the_aichemist_codex.domain.repositories",
    "the_aichemist_codex.domain.services",
    "the_aichemist_codex.application.services",
    "the_aichemist_codex.infrastructure.config",
    "the_aichemist_codex.infrastructure.persistence",
    "the_aichemist_codex.interfaces.api",
    "the_aichemist_codex.cross_cutting.caching",
    "the_aichemist_codex.cross_cutting.security",
]
            ...
            "html": """
                <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                    ...
                    <path fill-rule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47
                         ...
                         3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15
